...
public class GemstoneStaff() : TheInventorCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{
    public override string GetScrapId => nameof(WallOfIce);

    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(12, BlockProps.card), new PowerVar<FreezePower>(1)];
