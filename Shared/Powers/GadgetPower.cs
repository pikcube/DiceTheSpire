...
public class GadgetPower : TheInventorPower, IGadgetParent
{
    ...
    public string InitialGadgetId //Used to preload the name before we apply the power
    {
        ...
        {
            field = value;
            GadgetText = $"[gold]Gadget[/gold]: {ScrapManager.AllGadgets[field].Description.GetFormattedText()}";
    ...
    public void Update()
    {
        GadgetText = $"[gold]Gadget[/gold]: {LinkedGadgetModel.Description.GetFormattedText()}";
