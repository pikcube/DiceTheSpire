...
public class InfestedAutomatonPatch
{
    public static IReadOnlyList<EventOption> Postfix(IReadOnlyList<EventOption> __result, InfestedAutomaton __instance)
    {
        ...
        [
            ...
            new(__instance, () => OnChosen(__instance, __instance.Owner, inventor), "DICETHESPIRE-INFESTED_AUTOMATON.pages.INITIAL.options.SCRAP_CORE", new CardHoverTip(newGadget))
        ];
    ...
    private static async Task OnChosen(InfestedAutomaton instance, Player p, TheInventor _)
    {
        ...
        [
            new LocString(instance.LocTable, "DICETHESPIRE-INFESTED_AUTOMATON.SCRAP_CORE.description")
        ]);
