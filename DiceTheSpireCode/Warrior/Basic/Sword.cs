...
using DiceTheSpire.DiceTheSpireCode.Warrior.Ancient;
...
namespace DiceTheSpire.DiceTheSpireCode.Warrior.Basic;
...
public class Sword() : TheWarriorCard(3, CardType.Attack, CardRarity.Basic, TargetType.AnyEnemy), ITranscendenceCard
{
    ...
    public CardModel GetTranscendenceTransformedCard() => FourHandedSword.Create();
